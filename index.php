...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center light-background sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="admin/index.php" class="logo d-flex align-items-center me-auto me-xl-0">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <?php echo " <img src='" . $data['url_hero'] . "' alt=''>"; ?>

      <div class="container text-center" data-aos="zoom-out" data-aos-delay="100">
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <?php echo "<h1>" . $data['nama_depan'] . " " . $data['nama_belakang'] . "</h1>"; ?>
            <p>I'm a professional <?php echo $data['profesi']; ?> from <?php echo $data['kota']; ?></p>
