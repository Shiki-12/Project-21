              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Put your conctact here!
                  </p>
                  <form action="../../../database/prs_kontak.php" class="form-sample" method="POST">
                    <div class="">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label for="Deskripsi Kontak" class="col-sm-3 col-form-label">Deskripsi Kontak</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="deskripsi_kontak" placeholder="Deskripsi Kontak"
                              name="deskripsi_kontak" required />
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label for="Peta" class="col-sm-2 col-form-label">Kode Peta</label>
                          <div class="col-sm-10">
                            <textarea class="form-control" name="peta" id="peta" rows="6" placeholder="Paste kode semat Google Maps di sini..." required></textarea>
                          </div>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-gradient-success mr-2">Submit</button>
                      <a class="btn btn-gradient-secondary" href="kontak.php">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
